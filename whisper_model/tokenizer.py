...
class Tokenizer:
    ...
    def __post_init__(self):
        ...
        tranlate_chinese: int = self.special_tokens["<|translate-chinese|>"]
    ...
    @cached_property
    def translate_chinese(self) -> int:
        return self.special_tokens["<|translate-chinese|>"]
