...
class WHISPER_TOOL():
    def __init__(self):
        ...
        # 评估
        peft_model_id = "reach-vb/whisper-large-v2-uygur-1000steps-100epochs" # Use the same model ID as before.
...
if __name__ == "__main__":
    ...
    file_path = "/home/towardspring/projects/asr/faster_whisper_fineturning/data/common.mp3"  # 替换为你的MP3文件路径
